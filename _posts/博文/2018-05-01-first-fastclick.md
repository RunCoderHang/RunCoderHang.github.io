...
为了<a href="https://hangforfreedom.github.io/2018/05/01/use-headroom.html" target="_blank">实现导航栏在滚动页面时消失</a>，我浏览一位博主的博客作为案例。在源码中，我发现一个``fastclick.js``插件，于是好奇地查找它的作用。  
